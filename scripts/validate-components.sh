...
# repository or explicitly supported as standalone components, ensuring they
# were built and tested successfully.
...
valid_components+='
github.com/prometheus/prometheus-opentelemetry-collector/receivers/blackbox'
valid_components+='
github.com/prometheus/prometheus-opentelemetry-collector/receivers/postgres'
valid_components+='
